package com.vicmar57.dogshelter.service;
...
public class DogServiceIm implements DogService {
	...
	public List<String> atriskdogs(Date rescued){
		String sql = "SELECT * FROM dog WHERE rescued < '"+
				new SimpleDateFormat("yyyy-MM-dd").format(rescued) +"' AND vaccinated = '0'";
		List<String> dogList = new ArrayList<String>();
		//String dateForQuery = new SimpleDateFormat("yyyy-MM-dd").format(rescued);
		JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
